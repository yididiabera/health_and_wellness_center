...
import { Autoplay, Pagination, EffectFade, Parallax, EffectCube } from "swiper/modules"
import "swiper/css"
...
`}</style>
            ...
            {/* ===================== Features Section ===================== */}
            <section className="py-8 md:py-12 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
                <div className="container mx-auto px-4 lg:px-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-10">
                        {features.map((feature, index) => (
                            <motion.div
                                key={feature.title}
                                className="relative group rounded-3xl shadow-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 overflow-hidden"
                                initial={{ opacity: 0, y: 40 }}
                                whileInView={{ opacity: 1, y: 0 }}
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-br from-teal-500/20 via-transparent to-teal-600/20 opacity-0 group-hover:opacity-100 transition-all duration-500"></div>

                                {/* Animated border effect */}
                                <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                                    style={{
                                ...
                                <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 p-8 md:p-10">
                                    <div className="flex-shrink-0">
                                        <motion.div
                                            className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-teal-100 to-teal-200 dark:from-teal-900 dark:to-teal-800"
                                            whileHover={{
                                                scale: 1.2,
                                                rotate: 360,
            ...
            <div className="relative w-full h-[120px] overflow-hidden bg-white dark:bg-gray-900">
                <div className="absolute bottom-0 left-0 w-[200%] h-[120px]">
                    {/* Gradient Wave (background) */}
                    <svg
                        className="absolute bottom-0 left-0 w-[200%] h-[120px] animate-wave-slow"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 1440 320"
                        preserveAspectRatio="none"
                    >
                        <defs>
                            <linearGradient id="gradientCurve2" x1="0" y1="0" x2="1" y2="1">
                                <stop offset="0%" stopColor="#14b8a6" />
                                <stop offset="50%" stopColor="#0d9488" />
                                <stop offset="100%" stopColor="#0f766e" />
                            </linearGradient>
                    ...
                    {/* White Wave (foreground) */}
                    <svg
                        className="absolute bottom-0 left-0 w-[200%] h-[120px] opacity-70 animate-wave-fast"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 1440 320"
                        preserveAspectRatio="none"
                    >
            ...
            {/* ===================== Wave Animation Between Sections ===================== */}
            <div className="relative w-full h-[120px] overflow-hidden bg-gray-100 dark:bg-gray-800">
                <div className="absolute bottom-0 left-0 w-[200%] h-[120px]">
                    {/* Gradient Wave (background) */}
                    <svg
                        className="absolute bottom-0 left-0 w-[200%] h-[120px] animate-wave-slow"
                    ...
                    >
                        <defs>
                            <linearGradient id="gradientCurve3" x1="0" y1="0" x2="1" y2="1">
                                <stop offset="0%" stopColor="#14b8a6" />
                                <stop offset="50%" stopColor="#0d9488" />
                                <stop offset="100%" stopColor="#0f766e" />
                            </linearGradient>
            ...
            {/* ===================== Huge Image Gallery ===================== */}
            <section className="py-8 md:py-12 bg-gray-100 dark:bg-gray-800">
                <div className="container mx-auto px-6 lg:px-12">
            ...
            {/* ===================== Wave Animation Between Sections ===================== */}
            <div className="relative w-full h-[120px] overflow-hidden bg-gray-50 dark:bg-gray-800">
                <div className="absolute bottom-0 left-0 w-[200%] h-[120px]">
                    {/* Gradient Wave (background) */}
                    <svg
                        className="absolute bottom-0 left-0 w-[200%] h-[120px] animate-wave-slow"
                    ...
                    >
                        <defs>
                            <linearGradient id="gradientCurve4" x1="0" y1="0" x2="1" y2="1">
                                <stop offset="0%" stopColor="#14b8a6" />
                                <stop offset="50%" stopColor="#0d9488" />
                                <stop offset="100%" stopColor="#0f766e" />
                            </linearGradient>
            ...
            {/* ===================== CTA ===================== */}
            <section className="py-8 md:py-12 bg-gradient-to-r from-teal-600 to-teal-500 dark:from-teal-700 dark:to-teal-600">
