                ...
                <div className="container mx-auto px-6 lg:px-12">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        {serviceDetails.map((service, index) => (
                            ...
                            >
                                <div className="relative bg-white dark:bg-gray-800 rounded-3xl p-10 shadow-lg hover:shadow-2xl transform hover:-translate-y-3 transition-all duration-500 border border-gray-100 dark:border-gray-700 overflow-hidden">
                                    {/* Subtle gradient overlay on hover */}
                                    <div className="absolute inset-0 bg-gradient-to-br from-teal-50/50 via-transparent to-teal-100/50 dark:from-teal-900/20 dark:via-transparent dark:to-teal-800/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                                    ...
                                    {/* CTA */}
                                    <Button className="relative z-10 w-full" size="lg" asChild>
