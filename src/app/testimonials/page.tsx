...
export default function TestimonialsPage() {
  const stats = [
    { number: 500, suffix: "+", label: "Happy Clients", icon: <Smile className="h-10 w-10 text-teal-600 mb-2" /> },
    { number: 4.9, suffix: "", label: "Average Rating", icon: <Star className="h-10 w-10 text-yellow-400 mb-2" /> },
    { number: 95, suffix: "%", label: "Success Rate", icon: <Heart className="h-10 w-10 text-pink-500 mb-2" /> },
  ]
  ...
  return (
    <div className="flex flex-col space-y-16">
      ...
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-br from-teal-50 to-white dark:from-gray-900 dark:to-gray-800">
        <div className="container mx-auto px-4 text-center">
          <motion.h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6"
            initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            Client Testimonials
          </motion.h1>
          <motion.p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto"
      ...
      {/* Stats Section */}
      <section className="py-16 bg-gradient-to-tr from-teal-100 to-white dark:from-gray-800 dark:to-gray-900">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                {stat.icon}
                <div className="text-5xl md:text-6xl font-extrabold text-teal-600 dark:text-teal-400 mb-2">
        ...
        <div className="container mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-teal-600 rounded-full">
