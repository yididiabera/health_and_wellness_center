                ...
                <div className="container mx-auto px-6 lg:px-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                        {values.map((value, index) => (
                            <motion.div
                                key={value.title}
                                className="relative group p-6 rounded-2xl shadow-lg bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-transform duration-500 overflow-hidden"
                                initial={{ opacity: 0, y: 40 }}
                                whileInView={{ opacity: 1, y: 0 }}
                            ...
                            >
                                ...
                                <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                                    style={{
                                ...
                                <div className="absolute inset-0 bg-gradient-to-br from-teal-50/70 via-transparent to-teal-100/70 dark:from-teal-900/30 dark:via-transparent dark:to-teal-800/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

                                {/* Card Content */}
                                <div className="relative z-20 text-center">
                                    <motion.div
                                        className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-br from-teal-100 to-teal-200 dark:from-teal-900 dark:to-teal-800 mb-4"
                                        whileHover={{
                                            scale: 1.3,
                                            rotate: 360,
